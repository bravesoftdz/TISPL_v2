...
{              
	...
	if(Button==mbLeft)//zohlední jenom stisk levého tlačítka myši
	{
		...
		switch(Akce)
		{
			...
			case MOVE_TEXT:if(OBJEKT_akt!=NULL && vychozi_souradnice_kurzoru.x==minule_souradnice_kurzoru.x && vychozi_souradnice_kurzoru.y==minule_souradnice_kurzoru.y){nastav_focus();stav_kurzoru=false;editace_textu=true;index_kurzoru=-6;nazev_puvodni=OBJEKT_akt->name;TimerKurzor->Enabled=true;}Akce=NIC;kurzor(standard);pom_vyhybka=NULL;d.v.vytvor_obraz_DATA();break;
			case MOVE_BOD:
...
void __fastcall TForm1::Button13Click(TObject *Sender)
{
	...
	Memo("OK");
//	Cvektory::TElement *E=OBJEKT_akt->element;
//	TscGPComboBox *C1=NULL,*C2=NULL;
//	while(E!=NULL)
//	{
//		if(E->eID==200 || E->eID==300)
//		{
//			C1=E->mGrid->getCombo(3,2);
//			C2=E->mGrid->getCombo(4,2);
//			if(C1!=NULL && C1->ItemIndex==0){C1->DropDown();FormX->vstoupeno_elm=true;}
//			if(C2!=NULL && C2->ItemIndex==0){C2->DropDown();FormX->vstoupeno_elm=true;}
//			C1=NULL;
//			C2=NULL;
//    }
//		E=d.v.dalsi_krok(E,OBJEKT_akt);
...
//	if(predchozi_PM)
//	{
//		C1=predchozi_PM->mGrid->getCombo(3,2);
//		C2=predchozi_PM->mGrid->getCombo(4,2);
//		if(C1!=NULL && C1->ItemIndex==0){C1->DropDown();FormX->vstoupeno_elm=true;}
//		if(C2!=NULL && C2->ItemIndex==0){C2->DropDown();FormX->vstoupeno_elm=true;}
//  }
//	E=NULL;delete E;
//	C1=NULL;delete C1;
//	C2=NULL;delete C2;    nastav_focus();
}
//---------------------------------------------------------------------------
