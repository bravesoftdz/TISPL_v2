...
Cvektory::TObjekt *TForm1::add_objekt(int X, int Y)
{
	...
	if(vybrany_objekt>-1)
	{
		...
		short oblast=0;
		Cvektory::TElement *e_posledni_pom=d.v.vrat_posledni_element_objektu(pom);
		Cvektory::TElement *e_posledni=d.v.vrat_posledni_element_objektu(d.v.OBJEKTY->predchozi);
...
TPoint TForm1::uprav_bod_vlozeni_elementu(TPoint bod_vlozeni,short rotace_symbolu,int eID)
{
	...
	//nastavení atribuutů
	double DoSkRB=0;
	double orientace=akt_Objekt->orientace;
