...
//	if(F->pom_element!=NULL && (F->pom_element->dalsi==v.MAG_LASO->predchozi->Element))
//	{
...
//	}
//
//	if(v.MAG_LASO->dalsi!=NULL && F->pom_element!=NULL && F->pom_element->dalsi==v.MAG_LASO->predchozi->Element)
//	{
