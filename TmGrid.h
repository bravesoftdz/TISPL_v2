...
class TmGrid
{
 public:
	...
	void InsertColumn(unsigned long Column,bool copyPropertiesFromPreviousColumn=true,bool invalidate=true);//přídá sloupec za sloupec uvedený dle parametru Column, pokud copyropertiesFromPreviouscolumn je na true, zkopiruje kompomenty a vlasnosti z předchozího sloupce, pokud je invalidate na true, automaticky po přidání překreslí tabulku, někdy pokud nechci problikávat tabulku lépe nastavit na false a zavolat formpaint přímo za voláním metody InsertColumn přimo v užitém formuláři
