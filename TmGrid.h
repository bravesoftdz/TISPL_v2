...
class TmGrid
{
 public:
	...
	void HighlightRow(long Row,TColor Color=clYellow,bool SelFirstRow=false);//zajistí zvıraznìní øádkù dle èísla øádku Row
	void HighlightRowOnMouse(int X,int Y,TColor Color=clYellow,bool SelFirstRow=false);//zajistí zvıraznìní øádkù, pøes kterı se pøejídí myší
