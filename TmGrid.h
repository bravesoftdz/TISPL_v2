...
class TmGrid
{
 public:
	...
	struct TCells//datovı typ pouívanı pro buòky
	{
		...
		//PODMÍNÌNÉ FORMÁTOVÁNÍ - Pozor pro pøípady kdy se pouívá jinı font, napø. v našem pøípadì Roboto Cn na mgridech v náhledu, je nutné vdy nastavovat i název fontu a velikost nejenom pro normální text, ale i pro podmínìné formátování, defualtnì je nastaveno vše na naši modrou + velikost 12 pt, kromì záporného èísla, které je ve vıchozím stavu nastaveno na èervenou
	...
	bool exBUTTONVisible;//stav zobrazení èi skrytí exBUTTNU, nepouívat pøímo exBUTTON->Visible, ale toto exBUTTONVisible
