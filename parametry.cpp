...
void __fastcall TForm_parametry::scGPGlyphButton_pasteClick(TObject *Sender)
{
  ...
  //pøevod jednotek
	...
	scGPNumericEdit_CT->Decimal=Form1->ms.get_count_decimal(pom->CT/jednotky_cas);//nastaví zobrazení poètu desetinných míst;
	...
	scGPNumericEdit_delka_dopravniku->Decimal=Form1->ms.get_count_decimal(pom->delka_dopravniku*jednotky_vzdalenost);//nastaví zobrazení poètu desetinných míst;
