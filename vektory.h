...
//metody pro OBJEKTY
		...
		unsigned int pocet_objektu(short typ=0);//vrátí počet objektů v požadovaném režimu, nebo v případě implicitního parametru -1 objekty ve všech režimech
		unsigned int pocet_objektu(TZakazka *Zakazka,short typ=0);//vrátí počet objektů v požadovaném režimu pro danou zakázku, nebo v případě implicitního parametru -1 objekty ve všech režimech pro danou zakázku
