...
//metody pro POHONY
		...
		void zrusit_prirazeni_pohunu_k_objektum(unsigned long n);//všem objektům s n pohonem zruší přířazení k tomuto pohonu a nahradí hodnotu tohoto ukazatele za NULL
