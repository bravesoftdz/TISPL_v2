...
void __fastcall TF_gapoR::FormActivate(TObject *Sender)
{
	...
	//manualfit šíøky sloupcù mimo prvního (ten je øešen níže pomocí SetColumnAutoFit(0);
	...
	mGrid->SetCells(mGrid->Cells[5][1],5,2,5,ColCount-2);
	mGrid->Cells[5][ColCount-1].RightBorder->Width=mGrid->Cells[5][1].RightBorder->Width;
