...
//	bool KOLIZE(Cvektory::TVozik *V1,Cvektory::TVozik *V2);//vrací logickou hodnotu zda došlo èi nedošlo ke kolizi s jinım vozíkem
	...
	void vykresli_legendu_casovych_os(TCanvas *canv);//vykreslí legendu pro jednotlivé procesy na èasovıch osách
	...
	short legenda_polozky[8];//zobrazení jednotlivıch poloek 0 index je však poèet zobrazenıch
