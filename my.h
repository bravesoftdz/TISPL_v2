...
class Cmy
{
  ...
  public:
	...
	double RT(double PTciWTstop,double delka_prejezdu,double RD,double R,double WT=-1);//vratí hodnotu RT (reserve time), ta mùže být i záporná, WT èekání na palac si dopoèítává metoda sama, pokud WT==0, pokud je dosazena kladná hodnota, tak je ta uvažovaná jako WT, -1 hodnota znamena WT èekání na palec neuvažovat
