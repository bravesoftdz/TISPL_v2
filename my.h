...
class Cmy
{
  ...
  long px_offset(unsigned int X,unsigned int Y,long Distance);//vráti souøadnice pixelù posunuté o Distance METRù
	...
	double null(double number,double tolerance=0.0000000001);//zkatroluje èíslo, zda se nejadná o hodnout okolo nuly dle možné odchylky dle toleration, pøedchází zvláštnímu chování výpoètù okolo nuly
