object Form_kalibrace: TForm_kalibrace
  Left = 0
  Top = 0
  BorderStyle = bsNone
  Caption = 'Form_kalibrace'
  ClientHeight = 177
  ClientWidth = 641
  Color = clBtnFace
  ...
  object scGPPanel_hlavicka: TscGPPanel
    ...
    object scLabel_titulek: TscLabel
      ...
      Caption = 'Kalibrace podkladu '
      ExplicitWidth = 300
    end
  end
  object scGPNumericEdit1: TscGPNumericEdit
    Left = 412
    Top = 65
    Width = 156
    Height = 29
