...
private:	// User declarations
	...
	void Nacti_rx();
	void VALIDACE(Tinput_state input_state=NOTHING);//validace vöech hodnot po p¯epoËtu z PO_math
...
public:		// User declarations
  ...
  Tinput_clicked_icon input_clicked_icon;//zjisteni na ktery icon bylo kliknuto
	unsigned short kapacitaSG;//poûadavek na rozpad na vÌce stejn˝ch S&G objekt˘
	bool existuje_pohon;
