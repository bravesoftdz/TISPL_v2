...
private:	// User declarations
	...
	enum Tinput_state{NO,NOTHING,CT,DD,RD,C,mezera};//uchov·v· v˝bÏr input hodnoty (aby se formul·¯e necyklyly)
	...
	void input_mezera(); //p¯epoËet hodnot vypl˝vajÌcÌch ze zmÏny mezery
	void null_input_value();//vynuluje vstupnÌ hodnoty
	TParametry_math pm;//INSTANCE NA V›PO»ETNÕ »¡ST PO tj. parametry_math
