	...
	: TForm(Owner)
{
	...
	for(unsigned int i=0;i<=6;i++)
	{
		switch(i)
		{
			...
			case 3:text="<font color=#FF0000> The scale setting on your computer is not compatible with this application. For proper operation, change the application settings using this manual. </font>;<font color=#FF0000>Nastavení mìøítka na vašem poèítaèi není kompatibilní s touto aplikací. Pro správný chod zmìòte nastavení aplikace pomocí tohoto návodu.</font>";break;
			case 4:text="1. Right-click the <font color=#2b579a> TISPL.exe </font> file to display the <font color=#2b579a> Properties </font> file. Now go to the <font color=#2b579a> Compatibility </font> tab. Click here the button shown in Figure 1.;1.Kliknìte pravým tlaèítekm myši na soubor <font color=#2b579a>TISPL.exe</font>, zobrazte <font color=#2b579a>Vlastnosti</font> souboru. Nyní pøejdìte do záložky <font color=#2b579a>Kompatibilita</font>. Zde kliknìte na tlaèítko znázornìné na obrázku è. 1.";break;
