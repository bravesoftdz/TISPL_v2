...
public:
	...
	enum Tm_mm{M=0,MM};Tm_mm DOtocunit,DKunit,LOunit;//p¯epÌnaË jednotek vzd·lenost
	enum Tminsec{SEC=0,MIN};Tminsec PTunit;Tminsec ;//p¯epÌnaË jednotek Ëasu
...
public:		// User declarations
  ...
  int knihovna_id; // id drawgrid knihovny
	...
	AnsiString editovany_text;//uchov·v· editovanou hodnotu kÛt
	int index_kurzoru;
