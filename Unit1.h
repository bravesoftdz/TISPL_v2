...
public:
	...
	enum Takce{NIC=0,PAN,PAN_MOVE,ZOOM_W,ZOOM_W_MENU,ADD,MOVE,VYH,MEASURE,KALIBRACE,ADJUSTACE,MOVE_ELEMENT,MOVE_TABLE,OFFSET_KOTY,MOVE_KOMORA,ROZMER_KOMORA,DRAW_HALA,MOVE_HALA,MOVE_BOD,MOVE_USECKA};Takce Akce;
...
public:		// User declarations
  ...
  void aktualizace_ComboPohon ();
	...
	TRect vrat_max_oblast(Cvektory::TObjekt *Objekt);//vracÌ max a min hodnoty x a y sou¯adnic, vöecho v layout(element˘, objekt˘), nebo parametrem Objekt lze hledat max sou¯adnice v jednom objektu
