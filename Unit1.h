...
private:
  ...
  TRect oblast_prekryti_mGridu(Cvektory::TElement *E=NULL);//vrátí oblast pro kontrolu pøekrytí mGridù
	...
	bool pripnuti_dalsich_objektu(double citlivost=0.5);//pokud pøi uloení editovaného objektu je detekováno, e konec objketu nenavazuje na zaèátek následujísího objektu je poloen dotaz a po potvrzení dojde ke spojení
	...
	void napojeni_vedlejsi_vetve(Cvektory::TElement *e_posledni,bool kontrola_vzdalenosti=true);//provede kontrolu, zdá je monost geometrii spojit, dotáe se a spojí geometrii pokud uivatel souhlasí
