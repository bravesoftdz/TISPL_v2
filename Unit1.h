...
public:
	...
	enum Tm_mm{M=0,MM};Tm_mm DOtocunit,DKunit,LOunit,Runit,Rzunit;//p¯epÌnaË jednotek vzd·lenost
...
private:
  ...
  //toto je na co?:TWndMethod PreviousWndProc;
	...
	void design_tab_pohon(int index);//0=design tabulek po otev¯enÌ n·hledu, 1=zmÏna jednotek, 2=vybranÌ, Ëi odebr·nÌ pohonu, 3=˙prava tabulky podle vloûenÈho elementu (kontunu·lnÌ vs. S&G)
...
public:		// User declarations
  ...
  void NP_input(); // vol· zobrazenÌ PO - nahrazuje NP a NPin
	...
	void tab_pohon_COMBO (int index);//0=naËtenÌ pohon˘ do COMBA, 1=p¯i¯azenÌ pohonu kabinÏ, 2=zmÏna jednotek
