...
private:
  ...
  void mGrid_mimo_obraz(Cvektory::TElement *E);//kontrola zde je mGrid mimo obraz, pokud ano vypnutÌ komponent
	...
	TPoint bod_vlozeni_elementu();//vracÌ bod vloûenÌ elementu, "p¯ilepuje" kurzor na geometrii pokud se jedn· o p¯Ìmku
	TPoint uprav_bod_vlozeni_elementu(TPoint bod_vlozeni,short rotace_symbolu);//upravÌ bod kurzoru pro vloûenÌ elemntu na bod vykreslenÌ elementu (robot na konci ramena)
