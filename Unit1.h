...
private:
	...
	void OtevritSoubor();//realizuje otev¯enÌ opendialogu s n·sledn˝m vol·nÌm realizace samotnÈho otev¯enÌ souboru
	unsigned short int OtevritSoubor(UnicodeString soubor);//realizuje samotnÈ otev¯enÌ souboru
	...
	void NewDesignSettings();//nastavenÌ noveho designu
	...
	void close_all_items_popUPmenu(bool vyjimka);//zajistÌ skr˝tÌ vöech poloûek popUPmenu
	////promÏnnÈ
	TDateTime TIME;
...
public:		// User declarations
  ...
  bool grid;
	...
	void REFRESH(bool invalidate=true); //vybere buÔ Invalidate nebo FormPaint(this) dle if(!antialiasing a dle Invalidate=true), tedy kdyû bude zapnut˝ antialising jde vûdy do vÏtve else
