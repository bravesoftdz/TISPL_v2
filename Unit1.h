...
public:		// User declarations
  ...
  double inDO (double outDO);
	...
	TPoint bod_vlozeni_elementu(Cvektory::TElement *E_kontrolni=NULL);//vracÌ bod vloûenÌ elementu, "p¯ilepuje" kurzor na geometrii pokud se jedn· o p¯Ìmku, parametr E_kontorlnÌ slouûÌ ke kontrole tohoto elementu zda se nach·zÌ na p¯Ìmce (p¯i posunu)
};
//---------------------------------------------------------------------------
