...
private:
  ...
  unsigned short int Nacist_podklad(UnicodeString soubor);//realizuje nacteni podkladu
	...
	bool najdi_nazev_obj(double X,double Y,Cvektory::TObjekt *Objekt,int typ=0);//vratí zda jsem v oblasti textu, typ 0 citelná oblast textu, typ 1 citelná oblast posun. køíe
